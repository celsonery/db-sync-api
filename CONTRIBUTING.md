...
Contributions are **welcome** via Pull Requests on [Github](https://github.com/celsonery/db-sync-api).
...
If you want to run the test suite of Package, try out the `composer tests` or `php artisan test` or `./vendor/bin/phpunit` commands.
